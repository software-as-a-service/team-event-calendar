$vm.module_list={
    ...
    event_record:                ['20003773','.../modules/event/event_record.html','2'],
    daily:                       ['--------','.../modules/calendar/daily.html','2',  'event_record'],
    weekly:                      ['--------','.../modules/calendar/weekly.html','2', 'event_record','daily'],
    monthly:                     ['--------','.../modules/calendar/monthly.html','2','event_record','daily'],
}
//--------------------------------------------------------
